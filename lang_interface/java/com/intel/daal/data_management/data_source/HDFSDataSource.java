...
/**
 *  <a name="DAAL-CLASS-DATA_MANAGEMENT__DATA_SOURCE__HDFSDataSource"></a>
...
public class HDFSDataSource extends DataSource {
     ...
     *Default constructor
     */
    public HDFSDataSource(DaalContext context, String filename) {
        super(context);
     ...
     * Constructor
     */
    public HDFSDataSource(DaalContext context, String filename, DictionaryCreationFlag doDict,
